...
<!-- If your PR modifies aspects of the game that can be concretely observed by players or admins you should add a changelog. If your change does NOT meet this description, remove this section. Be sure to properly mark your PRs. Please note that developers & maintainers freely reserve the right to remove and add tags should they deem it appropriate. It's best to shoot for clear communication right off the bat. -->
...
qol: made some things easier to use
...
experiment: implemented an experimental thingy
balance: rebalanced something
code_imp: improved some internal code
refactor: refactored some internal code
