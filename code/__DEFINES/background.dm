...
#define CITIZENSHIP_INDEPENDENT "Independent"
...
CITIZENSHIP_ELYRA_NCP, CITIZENSHIP_ERIDANI, CITIZENSHIP_DOMINIA, CITIZENSHIP_INDEPENDENT, CITIZENSHIP_IZWESKI, CITIZENSHIP_NRALAKK,\
