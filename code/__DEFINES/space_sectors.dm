...
#define SECTOR_AL_MAQDISI			"Al-Maqdisi"	//The Republic of Assunzione is here
...
#define ALL_VOID_SECTORS		list(SECTOR_LIGHTS_EDGE, SECTOR_AL_MAQDISI, SECTOR_LEMURIAN_SEA, SECTOR_LEMURIAN_SEA_FAR)
